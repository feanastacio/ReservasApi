...
using Reversas.Teste.MockData;

namespace Reversas.Teste.Controllers
{
    public class ReservasControllerTeste
    {
        ...
        public void GetReservaPorId_DeveRetornar200_QuandoEncontrar()
        {
            ...
            var reserevaService = new Mock<IReservaRepository>();
            reserevaService.Setup(i => i[reservaMock.ReservaId]).Returns(reservaMock);
            var sut = new ReservasController(reserevaService.Object);
        ...
        [Fact]
        public void PostReservaa_DeveRetornar201Status()
        {
            //Arrange - Organizar
        ...
        [Fact]
        public  void PutReserva_DeveRetornar200_QuandoAAtualizada()
        {
            //Arrange - Organizar
